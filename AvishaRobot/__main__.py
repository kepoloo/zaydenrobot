...
import AarohiX.modules.no_sql.users_db as sql
from AarohiX import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
...
from AarohiX.modules.helper_funcs.chat_status import is_user_admin
from AarohiX.modules.helper_funcs.misc import paginate_modules
...
DONATE_STRING = f"""❅ ʜᴇʏ ʙᴀʙʏ, ʜᴀᴩᴩʏ ᴛᴏ ʜᴇᴀʀ ᴛʜᴀᴛ ʏᴏᴜ ᴡᴀɴɴᴀ ᴅᴏɴᴀᴛᴇ. ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @FounderGit ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @JooxSupport ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AarohiX.modules." + module_name)
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="avisha_back"),
                        InlineKeyboardButton(
                            text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/JooxStream"
                        ),
                    ],
                ]
            ),
...
def AarohiX_Main_Callback(update: Update, context: CallbackContext):
    query = update.callback_query
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1149301515:
            update.effective_message.reply_text(
                f"❅ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://t.me/FounderGit)"
    ...
    x=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴀᴅᴅ ᴍᴇ",
                            url="https://t.me/ZaydenStreamBot?startgroup=true"
                            )
                       ]
                ]
                     )
...
**❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ [˹𝙕𝙖𝙮𝙙𝙚𝙣 ✘ 𝙅𝙤𝙤𝙭 🎧˼](https://t.me/JooxStream)**
     ━━━━━━━━ ⊱◈◈◈⊰ ━━━━━━━━
""",reply_markup=x,
                parse_mode=ParseMode.MARKDOWN,
            )
    ...
    AarohiX_main_handler = CallbackQueryHandler(
        AarohiX_Main_Callback, pattern=r".*_help",run_async=True)
    ...
    dispatcher.add_handler(AarohiX_main_handler)
